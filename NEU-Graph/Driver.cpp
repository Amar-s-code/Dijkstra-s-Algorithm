...
istream.open("D:\\NEU\\Fundamentals of Computer Engineering\\HW5\\graph-load.txt");
...
istream1.open("D:\\NEU\\Fundamentals of Computer Engineering\\HW5\\graph-load.txt");
//exit if there is an error opening the file
if(istream1.fail()){
	cerr<<"Error opening file \n";
	exit(1);
...
dijkstras(verticesList, edges_w_weights, adjacencyList, "26", "34");
